...
type PredictionStatusActionsProps = {
  predictionId: string;
  status: string;
};
...
export function PredictionStatusActions({ predictionId, status }: PredictionStatusActionsProps) {
  ...
  async function updateStatus() {
    ...
    const response = await fetch(`/api/admin/predictions/${predictionId}/status`, {
      method: "POST",
